...
const PersonalInformationCard: React.FC<PersonalInformationCardProps> = ({ profile }) => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-[2.5rem] bg-white/88 sm:backdrop-blur-2xl dark:bg-[#050C14]/60 border border-emerald-200/40 dark:border-emerald-500/10 shadow-xl dark:shadow-[0_8px_40px_rgba(16,185,129,0.15)] transition-all duration-500"
    >
      ...
      <div className="relative p-4 sm:p-6 md:p-8">
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-6 mb-4 sm:mb-6 md:mb-8">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-xl rounded-2xl p-3 sm:p-4 md:p-5 border border-emerald-200/40 dark:border-white/10 hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-300 shadow-lg hover:shadow-xl">
