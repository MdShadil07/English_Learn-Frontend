          ...
          case 'business_tip':
            ...
            return (
              ...
              <div
                ...
                className="flex items-start gap-2 px-4 py-3 my-2 bg-emerald-50 dark:bg-[#050C14] border-l-4 border-emerald-500 dark:border-emerald-600 rounded-r-lg shadow-[inset_0_0_10px_rgba(16,185,129,0.02)]"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs font-semibold text-emerald-900 dark:text-emerald-200 uppercase tracking-wide mb-1">Professional Tip</p>

                  <p className="text-emerald-800 dark:text-emerald-300">{segment.content}</p>
